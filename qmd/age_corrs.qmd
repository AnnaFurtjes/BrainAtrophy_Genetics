...
The traits used for correlation analysis were derived using code displayed in 'Data preparation': UKB: [neuroimaging](../_site/UKB_neuro.html) & [phenotypic](../_site/UKB_pheno.html) data..
