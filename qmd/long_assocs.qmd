...
The outcome traits were derived using code displayed in 'Data preparation': LBC: [neuroimaging](../_site/LBC_neuro.html) & [phenotypic](../_site/LBC_pheno.html) data; UKB: [neuroimaging](../_site/UKB_neuro.html) & [phenotypic](../_site/UKB_pheno.html) data.
